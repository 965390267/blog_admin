...
Title
    ...
    <mu-menu slot="right">
      <mu-tooltip :content="isFullScreen?'退出全屏':'打开全屏'" placement="left">
        <mu-button flat @click="setFullscreen()">
          <div class="iconfont icon-quanping tooltips"></div>
        </mu-button>
      </mu-tooltip>
    </mu-menu>
    ...
    <mu-menu slot="right" open-on-hover placement="bottom">
      <mu-tooltip content="主题色" placement="bottom">
        <mu-button flat>
          <div class="iconfont icon-yanse tooltips"></div>
        </mu-button>
      </mu-tooltip>
    ...
    <mu-menu slot="right" open-on-hover>
      <mu-tooltip content="退出登录" placement="bottom">
        <mu-button flat>
          <div class="iconfont icon-guanji tooltips"></div>
        </mu-button>
      </mu-tooltip>
      <mu-list slot="content">
        <mu-list-item button>
